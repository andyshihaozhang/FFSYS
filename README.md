...
- 确保后端服务正在运行（端口8888）
- 检查浏览器控制台的CORS错误
- 确认前端 `.env` 文件中的API基础URL配置正确

### 如何修改默认端口？

**后端**: 在 `config.yaml` 中修改 `system.addr`
...
- **插件商城**: https://plugin.gin-vue-admin.com/
- **社区论坛**: QQ群 971857775
...
- **JavaScript/Vue**: 遵循 [Vue Style Guide](https://vuejs.org/style-guide/)
- **提交信息**: 使用规范的提交信息格式
...
- **Issue**: https://github.com/gin-vue-admin/gin-vue-admin/issues
- **Discussions**: https://github.com/gin-vue-admin/gin-vue-admin/discussions
- **QQ群**: 971857775

---

**Made with ❤️ by gin-vue-admin team**
